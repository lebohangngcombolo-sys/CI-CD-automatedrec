...
Revision ID: d16ab276a748
Revises: 
Create Date: 2026-01-08 13:14:53.040874
...
def upgrade():
    ...
    sa.Column('knockout_rules', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    sa.Column('weightings', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    sa.Column('assessment_pack', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    sa.Column('created_by', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('cv_parser_result', postgresql.JSON(astext_type=sa.Text()), nullable=True),
